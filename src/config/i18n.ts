...
export const translations: Record<'fr' | 'en', Translation> = {
  fr: {
    ...
    bio: 'À la recherche d\'un poste à temps plein\nSur site ou en télétravail hybride\nRive-Sud, Montréal',
    buttons: {
    ...
    chat: {
      ...
      privacyNotice: 'Votre confidentialité est importante ! Nous ne stockons aucun historique de chat ni information personnelle. Toutes les données sont effacées à la fermeture du chat.',
  ...
  en: {
    ...
    bio: 'Looking for a full-time position\nOn-site or hybrid remote work\nSouth Shore, Montreal',
    buttons: {
    ...
    chat: {
      ...
      privacyNotice: 'Your privacy matters! We don\'t store any chat history or personal information. All data is cleared when you close the chat.',
